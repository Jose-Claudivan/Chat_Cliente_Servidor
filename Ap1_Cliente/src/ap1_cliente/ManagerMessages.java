...
//     condição para exibir o emoji do coraçao
       if(str[2].equals("<3")){
        ...
        String path = "file:C:\\Users\\Juciana\\Documents\\NetBeansProjects\\Ap1_Cliente\\src\\ap1_cliente\\"+pathSeparator+"heart_icon.png";
...
//     condição para exibir o emoji do sorriso          
        ...
        String pathSeparator = File.separator;
        String path = "file:C:\\Users\\Juciana\\Documents\\NetBeansProjects\\Ap1_Cliente\\src\\ap1_cliente\\"+pathSeparator+"smile_icon.png";
...
//     condição para exibir o emoji do chorao        
        ...
        String pathSeparator = File.separator;
        String path = "file:C:\\Users\\Juciana\\Documents\\NetBeansProjects\\Ap1_Cliente\\src\\ap1_cliente\\"+pathSeparator+"crying_icon.png";
...
//     condição para exibir o emoji do like        
        ...
        String pathSeparator = File.separator;
        String path = "file:C:\\Users\\Juciana\\Documents\\NetBeansProjects\\Ap1_Cliente\\src\\ap1_cliente\\"+pathSeparator+"like_icon.png";
